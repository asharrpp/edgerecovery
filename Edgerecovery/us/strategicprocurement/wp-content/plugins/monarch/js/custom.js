(function($) {
    $(document).ready(function() {
        ...
        function append_total_shares($current_area) {
            ...
            $share_total_count_data = JSON.stringify({
                'post_id': post_id,
                'url': url
            });
        ...
        $('.et_social_heading, .et_social_mobile_button').click(function() {
            ...
            if ($this_mobile_div.hasClass('et_social_opened')) {
                ...
                $this_mobile_div.find('.et_social_networks').slideToggle(600);
                $('.et_social_mobile_overlay').addClass('et_social_visible_overlay').css({
                    'display': 'block'
                });
            }
        });
        ...
        function set_mobile_sidebar_height() {
            setTimeout(function() { // make sure all css transitions are finished to calculate the heights correctly
                ...
                if (!mobile_div.hasClass('et_social_opened')) {
                    $('.et_social_mobile .et_social_networks').css({
                        'display': 'block'
                    });
                }
                ...
                mobile_div.find('.et_social_networks').css({
                    'max-height': inner_contatiner_height,
            ...
            if ($('.et_social_media_wrapper').length) {
                $('.et_social_media_wrapper').each(function() {
                    ...
                    this_wrapper_media.css({
                        'max-height': this_image_height
                    });
                    this_wrapper_media.css({
                        'height': this_wrapper_networks_height + 50
                    });
        ...
        function et_pb_fix_gallery_slider_icons_size() {
            ...
            $all_galleries.each(function() {
                ...
                $this_gallery_media.css({
                    'max-height': icons_max_height
                });
            });
        }
